  ...
  return (
    <div className="fixed bottom-0 top-24 w-auto overflow-y-auto p-3">
      ...
      <div>
        ...
        from scratch is with the Tailwind CLI tool. The CLI is also available as
        a standalone executable if you want to use it without installing
        Node.js. Install Tailwind CSS Install tailwindcss via npm, and create
